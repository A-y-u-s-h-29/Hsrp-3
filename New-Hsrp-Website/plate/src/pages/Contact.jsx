...
const Contact = () => {
  ...
  // ✅ Cloudinary QR image URL — replace with your actual Cloudinary URL
  const displayImage = 'https://res.cloudinary.com/YOUR_CLOUD_NAME/image/upload/YOUR_IMAGE_ID.jpg';
