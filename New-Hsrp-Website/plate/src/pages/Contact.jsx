...
>
  ...
  <option value="Puducherry">Puducherry</option>
                      ...
                      <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          6~25 characters, letters/numbers/hyphen
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          4~20 characters, letters/numbers/hyphen
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:w-1/2">
                    <div className="space-y-6">
                      <div>
                        ...
                        />
                        <p className="text-xs text-gray-500 mt-1">
                          6~30 characters, letters/numbers/hyphen
                        </p>
                      </div>

                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                          Upload Payment Proof (PNG/JPG/PDF, ≤ 5MB)*
                        </label>
        ...
        <div className="flex justify-center items-center space-x-4 mt-8 text-sm text-gray-500">
          <div className="flex items-center">
            <div className={`w-6 h-6 rounded-full flex items-center justify-center ${step === 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
              1
            </div>
          ...
          <div className="flex items-center">
            <div className={`w-6 h-6 rounded-full flex items-center justify-center ${step === 2 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
              2
            </div>
